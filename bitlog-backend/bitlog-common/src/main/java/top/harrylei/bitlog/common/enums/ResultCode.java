...
public enum ResultCode implements IResultCode {
    ...
    RESOURCE_ALREADY_EXISTS(40011, "数据已存在，请勿重复提交"),

    // ========== 认证 41xxx ==========
    ACCOUNT_OR_PASSWORD_ERROR(41002, "账号或密码错误"),
    REFRESH_TOKEN_INVALID(41003, "Refresh Token 无效或已过期"),
    LOGIN_TOO_MANY_ATTEMPTS(41004, "登录失败次数过多，请稍后再试"),
    TOO_MANY_REQUESTS(41005, "操作过于频繁，请稍后再试"),
    VERIFY_CODE_INVALID(41006, "验证码无效或已过期"),
    OAUTH_EMAIL_UNVERIFIED(41007, "第三方账号的邮箱未验证"),
    ...
    // ========== 文件 44xxx ==========
    FILE_TYPE_NOT_ALLOWED(44001, "不支持的文件类型"),
    FILE_SIZE_EXCEEDED(44002, "文件大小超出限制"),

    // ========== AI 45xxx ==========
    AI_NOT_CONFIGURED(45001, "AI 功能未配置"),
    AI_SERVICE_ERROR(45002, "AI 服务调用失败"),

    // ========== 评论 46xxx ==========
    COMMENT_NOT_EXISTS(46001, "评论不存在"),
    COMMENT_NO_PERMISSION(46002, "无权操作该评论"),
    COMMENT_TOO_FREQUENT(46003, "评论过于频繁，请稍后再试"),
    COMMENT_NOT_ALLOWED(46004, "该文章当前不可评论"),

    // ========== 友链 47xxx ==========
    LINK_NOT_EXISTS(47001, "友链不存在"),
    LINK_ALREADY_APPLIED(47002, "已提交过友链申请"),
    LINK_URL_TAKEN(47003, "该站点已在友链中"),
    LINK_TOO_FREQUENT(47004, "操作过于频繁，请稍后再试"),
    LINK_STATUS_ILLEGAL(47005, "当前状态不允许该操作"),
