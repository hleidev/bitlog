...
public class UserDAO extends ServiceImpl<UserMapper, UserDO> {
    ...
    public List<Long> listAdminIds() {
        return lambdaQuery()
                .select(UserDO::getId)
                .eq(UserDO::getUserRole, UserRoleEnum.ADMIN)
                .eq(UserDO::getStatus, UserStatusEnum.ENABLED)
    ...
    public void deactivate(Long userId, String username, String email) {
        lambdaUpdate()
                ...
                .set(UserDO::getPassword, null)
                .set(UserDO::getDeleted, DeleteStatusEnum.DELETED)
                .update();
    }
